...
class AnomalieSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('anomalies')->insert([
            ...
            ['cause_anomalie' => 'Bruit anormal', 'action_corrective' => 'Lubrifier les roulements', 'priorite'=>'low', 'status'=>'Resolved' ,'id_intervenant'=>1, 'date_signalement' => now(), 'duree_panne' => 2, 'cout_reparation' => 50.00, 'anomalie_resolue' => true, 'id_user' => 1,'id_equipement' => 1],
