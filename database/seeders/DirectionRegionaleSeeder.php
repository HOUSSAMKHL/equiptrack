...
class DirectionRegionaleSeeder extends Seeder
{
    ...
    {
        $filePath = database_path('seeders/data/direction_regionales.xlsx');
        ...
        DB::table('direction_regionales')->insert($rows);
        $this->command->info(count($rows) . " direction_regionales inserted successfully.");
    }
}